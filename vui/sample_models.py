...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    # Recurrent layer
    gru_rnn = GRU(units, activation='relu', return_sequences=True, implementation=2)(input_data)
    # Batch normalization 
...
def final_model(input_dim, filters, kernel_size, conv_stride, conv_border_mode, units, output_dim = 29):
    ...
    simp_rnn_1 = Bidirectional(GRU(units, activation = 'relu', return_sequences=True, implementation = 2,dropout_U = 0.0,name = 'rnn1'), merge_mode = "concat")(bn_rnn)
    dropout_simp_rnn_1 = Dropout(0.0)(simp_rnn_1)
    bn_rnn_2 = BatchNormalization(name = "bn_rnn2")(dropout_simp_rnn_1)
    simp_rnn_2 = Bidirectional(GRU(units, activation = 'relu', return_sequences = True, implementation = 2,dropout_U = 0.0,name = 'rnn2'),merge_mode="concat")(bn_rnn_2)
    bn_rnn_3 = BatchNormalization(name = "bn_rnn3")(simp_rnn_2)
